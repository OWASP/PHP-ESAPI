...
abstract class Codec
{
     ...
     *
     * @param  $c string 4 byte character character.
     ...
     *
     * @param  $c Single character string that is potentially a hex digit
     *
     * @return boolean. True indicates that the single character string is a hex digit
     */
