...
interface Encoder {
     ...
     */
    /**
     * Lower case alphabet, for passwords, which exludes 'l', 'i' and 'o'.
     */
    const CHAR_PASSWORD_LOWERS = 'abcdefghjkmnpqrstuvwxyz';

    /**
     * Upper case alphabet, for passwords, which exludes 'I' and 'O'.
     */
    const CHAR_PASSWORD_UPPERS = 'ABCDEFGHJKLMNPQRSTUVWXYZ';

    /**
     * Numerical digits, for passwords, which exludes '0'.
     */
     ...
     *         for the desired SQL database (e.g. MySQL, Oracle, etc.).
